...
\newcommand{\acodenonu}{
	\lstset{ language={[x86masm]Assembler}, basicstyle=\small, numers=none, backgroundcolor=\color{white},frame=single, captionpos=b, breaklines=true,title=\lstname, keywordstyle=\color{blue},commentstyle=\color{dkgreen}, stringstyle=\color{mauve}, escapeinside={\%*}{*} }}
